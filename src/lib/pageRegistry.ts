...
export const pageRegistry: Record<ScreenKey, React.ComponentType> = {
  portfolio: PortfolioOverview, health: ProjectHealth, billing: RevenueBilling, approvals: ApprovalBottlenecks, docstatus: DocumentationStatus, drilldown: ProjectDrillDown,
  'tender-pipeline': TenderPipeline, 'tender-enquiry': EnquiryRegister, 'tender-bid': BidAnalysis, 'tender-costing': CostingPricing, 'tender-risk': RiskAssessment, 'tender-approval': TenderApprovals, 'tender-submit': SubmissionTracker, 'tender-wonlost': WonLostRegister,
  workspace: ProjectWorkspace, milestones: MilestoneTracker, packages: WorkPackageTracker, siteprog: SiteProgressView, taskboard: TaskAssignmentBoard, risks: RiskIssueBlocker, docready: DocumentReadiness, appfollow: ApprovalFollowUp, inspfollow: InspectionFollowUp, material: MaterialResource, commercial: CommercialProgress,
  'plan-overview': PlanningOverview, 'plan-wbs': WbsTimeline, 'plan-milestones': MilestoneRegister, 'plan-activities': ActivityRegister, 'plan-critical': CriticalFloatView, 'plan-resources': ResourcePlan, 'plan-lookahead': MonthlyLookahead,
  qainspections: InspectionRegister, qancr: NcrLog, qapunchlist: PunchList,
  'proc-mr': MaterialRequests, 'proc-rfq': RfqTracker, 'proc-po': PoRegister,
  'maint-dash': MaintenanceDashboard, 'maint-pm': PreventiveTasks, 'maint-cm': CorrectiveTasks,
};
